...
const RoleManagement = () => {
  ...
  const permissionOptions = [
    ...
    { name: 'View, Edit, Create, Delete', permissions: ['view', 'edit', 'create', 'delete'] },
  ];
  ...
  const handleSaveRole = () => {
    ...
    const selectedPermissions =
      permissionOptions.find((option) => option.name === newRole.permissions)?.permissions || [];
    ...
    if (isEditing) {
      ...
      const updatedRoles = roles.map((role) =>
        role.id === editingRoleId ? { ...role, name: newRole.name, permissions: selectedPermissions } : role
      );
  ...
  const handleEditRole = (roleId) => {
    ...
    if (roleToEdit) {
      const selectedOption = permissionOptions.find(
        (option) =>
          JSON.stringify(option.permissions) === JSON.stringify(roleToEdit.permissions)
      );
      setNewRole({
